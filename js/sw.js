const CACHE_NAME = 'ligeirinho-app-v536';
...
self.addEventListener('install', (event) => {
    /* Não chama skipWaiting aqui — a troca acontece na atualização automática
       (mensagem SKIP_WAITING + barra de progresso), como no Hub. */
