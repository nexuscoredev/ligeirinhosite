...
<span class="material-symbols-outlined">menu</span>
    ...
    const brandIcons = {
        ...
        instagram: svgDataUri(
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><defs><linearGradient id="ig" x1="0" y1="24" x2="24" y2="0" gradientUnits="userSpaceOnUse"><stop stop-color="#FD5949"/><stop offset=".5" stop-color="#D6249F"/><stop offset="1" stop-color="#285AEB"/></linearGradient></defs><path fill="url(#ig)" d="M12 0C8.74 0 8.333.014 7.053.072 5.775.132 4.602.333 3.635 1.27 2.668 2.24 2.396 3.394 2.338 4.673 2.28 5.953 2.266 6.36 2.266 12c0 5.64.014 6.047.072 7.327.058 1.28.26 2.453 1.197 3.42.937.966 2.11 1.168 3.39 1.226 1.28.058 1.689.072 7.347.072s6.067-.014 7.347-.072c1.28-.058 2.453-.26 3.42-1.197.966-.937 1.168-2.11 1.226-3.39.058-1.28.072-1.689.072-7.347s-.014-6.067-.072-7.347c-.058-1.28-.26-2.453-1.197-3.42-.937-.966-2.11-1.168-3.39-1.226C18.067.014 17.658 0 12 0Zm0 5.838a6.162 6.162 0 1 0 0 12.324 6.162 6.162 0 0 0 0-12.324ZM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm6.406-11.845a1.44 1.44 0 1 0 0 2.881 1.44 1.44 0 0 0 0-2.881Z"/></svg>'
        ),
        maps: svgDataUri(
            '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill="#48b564" d="M24 4C14.6 4 7 11.6 7 21c0 12.5 17 23 17 23s17-10.5 17-23C41 11.6 33.4 4 24 4Z"/><path fill="#fec412" d="M24 4v44s17-10.5 17-23C41 11.6 33.4 4 24 4Z"/><path fill="#d33f2f" d="M24 4C14.6 4 7 11.6 7 21c0 1.7.3 3.4.8 5h32.4c.5-1.6.8-3.3.8-5 0-9.4-7.6-17-17-17Z"/><circle fill="#fff" cx="24" cy="21" r="7"/><circle fill="#4285f4" cx="24" cy="21" r="5"/></svg>'
        ),
    };
